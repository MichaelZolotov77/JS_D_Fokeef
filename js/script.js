...
//1
let setEvents = new Set(gameEvents.values());
console.log(setEvents);
let events = Array.from(setEvents);
console.log(events);
...
//3
const avarageTime = Math.floor(90 / gameEvents.size);
console.log(
  `События в этом матче появлялись в среднем 1 раз в ${avarageTime} минут`
);
